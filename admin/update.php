          ...
          <div class="col-sm-6">
                <h1><i>Ajouter un item</i></h>
                  ...
                  <div class="form-action">
                    <button type="submit" value="submit" name="submit" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span>Modifier</button>
            ...
            <div class="thumbnail">
              <div class="class">
                <img src="<?php echo '../images/' .$image;?>" alt="..."/>
                   <div class="Lprice"><?php echo number_format((float)$price,2,'.','') . '$';?></div>
                   <div class="caption">
                        <h4><?php echo $name;?></h4>
